...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_IntegrationTime = QtWidgets.QLabel(self.groupBoxExposure)
        self.lbl_IntegrationTime.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_IntegrationTime.setObjectName("lbl_IntegrationTime")
        self.gridLayout.addWidget(self.lbl_IntegrationTime, 0, 1, 1, 1)
        self.spb_IntegrationTime = QtWidgets.QSpinBox(self.groupBoxExposure)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.spb_IntegrationTime.sizePolicy().hasHeightForWidth())
        self.spb_IntegrationTime.setSizePolicy(sizePolicy)
        self.spb_IntegrationTime.setMaximumSize(QtCore.QSize(16777215, 25))
        self.spb_IntegrationTime.setMaximum(10000)
        self.spb_IntegrationTime.setSingleStep(0)
        self.spb_IntegrationTime.setProperty("value", 1)
        self.spb_IntegrationTime.setObjectName("spb_IntegrationTime")
        self.gridLayout.addWidget(self.spb_IntegrationTime, 0, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_IntegrationTime.setText(_translate("MainWindow", "Integration Time"))
        self.spb_IntegrationTime.setToolTip(_translate("MainWindow", "<html><head/><body><p>Integration time in milliseconds. Value will update with actual time.</p></body></html>"))
