...
void CAMERALIBRARYSHARED_EXPORT setTargetValueLV(float x, float y);
void CAMERALIBRARYSHARED_EXPORT getCameraDataLV(long *dataOut);
void CAMERALIBRARYSHARED_EXPORT getControlValuesLV(float *controlBuffer);
...
static float *controlData = new float[6];
